...
public class Kategorija {
    ...
    public Kategorija(Integer id,String kategorija,boolean aktivnost) {
        this.id=id;
        this.naziv = kategorija;
    ...
    public void setNaziv(String kategorija) {
        this.naziv = kategorija;
    }
    ...
    public static boolean spasi(String naziv){
        try {
           ...
           PreparedStatement rs = Baza.DB.prepare("INSERT INTO kategorija VALUE(null,?,?)");
            
            rs.setString(1, naziv);
            rs.setBoolean(2, true);
            rs.executeUpdate();
    ...
    public boolean obrisi(){
        ...
        try {
            ...
            System.out.println("Pogrška : Niste azurirali aktivnost proizvod u bazu u tablicu kategorija");
